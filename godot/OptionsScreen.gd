...
const RAVES_ITEMS := [
	...
	{"key": "adventure_height", "label": "Adventure camera: height", "type": "slider",
		"min": 0, "max": 12, "step": 0.5},
	{"key": "adventure_distance", "label": "Adventure camera: distance", "type": "slider",
		"min": 3, "max": 40, "step": 1},
	{"key": "adventure_angle", "label": "Adventure camera: angle (degrees)", "type": "slider",
		"min": 5, "max": 85, "step": 1},
